$(document).ready(function(){
    ...
    var cols = [
        ...
        { title:'股票名称', name:'stockName' ,width:100, align:'center'},
        { title:'今收盘', name:'close' ,width:60, align:'right', renderer: fixed2},
        { title:'涨跌幅', name:'rises' ,width:60, align:'right',renderer: highliht},
        { title:'成交额(万)', name:'volume' ,width:100, align:'right', renderer: function(val){
            return (val / 10000).toFixed(2);
        }},
        { title:'今开盘', name:'open',width:60, align:'right', renderer: fixed2},
        { title:'最高价', name:'high' ,width:60, align:'right', renderer: fixed2},
        { title:'最低价', name:'low' ,width:60, align:'right', renderer: fixed2}
    ];
