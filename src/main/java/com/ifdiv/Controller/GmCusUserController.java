...
import com.ifdiv.demo.SmsSendDemo;
import com.ifdiv.utils.TimeUtils;
import com.ifdiv.vo.IphoneCodeVo;
import com.ifdiv.vo.UserVo;
import com.ifdiy.esmodel.BaseCommonConfig;
import com.ifdiy.esmodel.UtilEs;

@RestController
public class GmCusUserController{
    ...
    public Map<String,Object> login(IphoneCodeVo info) throws Exception {
		...
		user.setPhoneNo(info.getIphoneNo());
		map.put("code", "200");
		map.put("message", "OK");
		map.put("result", user);
        return map;
